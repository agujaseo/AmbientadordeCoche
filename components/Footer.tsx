                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-center justify-center sm:justify-start">
                                ...
                                <a href="mailto:info@ambientadordecoche.es" className="text-gray-400 hover:text-amber-400 transition-colors text-sm">info@ambientadordecoche.es</a>
                            </li>
                            <li className="flex items-center justify-center sm:justify-start">
                                ...
                                <a href="tel:+34622255862" className="text-gray-400 hover:text-amber-400 transition-colors text-sm">+34 622 255 862</a>
                            </li>
                        </ul>
